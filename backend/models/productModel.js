...
const productSchema = new mongoose.Schema({
  ...
  price: {type: Number, required: [true, "Please Enter Product Price"], maxLength: [7, "Price cannot exceed 7 digits"]},
  ...
  stock: {type: Number, required: [true, "Please Enter Product Stock"], maxLength: [5, "Price cannot exceed 5 digits"], default: 1},
